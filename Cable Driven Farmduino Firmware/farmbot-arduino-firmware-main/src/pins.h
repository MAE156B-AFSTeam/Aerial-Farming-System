#include "Board.h"
  ...
  #define E_ENCDR_A 22
  #define E_ENCDR_B 39
  #define E_ENCDR_A_Q -1    // N/A
  #define E_ENCDR_B_Q -1    // N/A
...
//////////////////////////////////
    // Encoder X channel A: pin 16, port H1
  #define ENC_E_A_PORT PINH
  #define ENC_E_A_BYTE 0x02

    // Encoder X channel B: pin 17, port H0
  #define ENC_E_B_PORT PINH
  #define ENC_E_B_BYTE 0x01

    // Encoder X channel A Q (disabled, use LED pin): pin 13, port B7
  #define ENC_E_A_Q_PORT PINB
  #define ENC_E_A_Q_BYTE 0x80

    // Encoder X channel B Q (disabled, use LED pin): pin 13, port B7
  #define ENC_E_B_Q_PORT PINB
  #define ENC_E_B_Q_BYTE 0x80
////////////////////////////////////////
    // Encoder Y channel A: pin 23, port A1
  #define ENC_Y_A_PORT PINA
  #define ENC_Y_A_BYTE 0x02
