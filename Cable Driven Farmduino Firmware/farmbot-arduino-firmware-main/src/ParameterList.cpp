...
void ParameterList::loadDefaultValue(int id)
{
  ...
  case MOVEMENT_TIMEOUT_X:
    ...
    break;
  case MOVEMENT_TIMEOUT_E:
    paramValues[id] = MOVEMENT_TIMEOUT_E_DEFAULT;
    break;  
  ...
  case MOVEMENT_KEEP_ACTIVE_X:
    ...
    break;
  case MOVEMENT_KEEP_ACTIVE_E:
    paramValues[id] = MOVEMENT_KEEP_ACTIVE_E_DEFAULT;
    break;
  ...
  case MOVEMENT_HOME_AT_BOOT_X:
    ...
    break;
  case MOVEMENT_HOME_AT_BOOT_E:
    paramValues[id] = MOVEMENT_HOME_AT_BOOT_E_DEFAULT;
    break;
  ...
  case MOVEMENT_INVERT_ENDPOINTS_X:
    ...
    break;
  case MOVEMENT_INVERT_ENDPOINTS_E:
    paramValues[id] = MOVEMENT_INVERT_ENDPOINTS_E_DEFAULT;
    break;
  ...
  case MOVEMENT_ENABLE_ENDPOINTS_X:
    ...
    break;
  case MOVEMENT_ENABLE_ENDPOINTS_E:
    paramValues[id] = MOVEMENT_ENABLE_ENDPOINTS_E_DEFAULT;
    break;
  ...
  case MOVEMENT_STEPS_ACC_DEC_X:
    ...
    break;
  case MOVEMENT_STEPS_ACC_DEC_E:
    paramValues[id] = MOVEMENT_STEPS_ACC_DEC_E_DEFAULT;
    break;
  ...
  case MOVEMENT_STOP_AT_HOME_X:
    ...
    break;
  case MOVEMENT_STOP_AT_HOME_E:
    paramValues[id] = MOVEMENT_STOP_AT_HOME_E_DEFAULT;
    break;
  ...
  case MOVEMENT_HOME_UP_X:
    ...
    break;
  case MOVEMENT_HOME_UP_E:
    paramValues[id] = MOVEMENT_HOME_UP_E_DEFAULT;
    break;
  ...
  case MOVEMENT_STEP_PER_MM_X:
    ...
    break;
  case MOVEMENT_STEP_PER_MM_E:
    paramValues[id] = MOVEMENT_STEP_PER_MM_E_DEFAULT;
    break;
  ...
  case MOVEMENT_MIN_SPD_X:
    ...
    break;
  case MOVEMENT_MIN_SPD_E:
    paramValues[id] = MOVEMENT_MIN_SPD_E_DEFAULT;
    break;
  ...
  case MOVEMENT_HOME_SPEED_X:
    ...
    break;
  case MOVEMENT_HOME_SPEED_E:
    paramValues[id] = MOVEMENT_HOME_SPEED_E_DEFAULT;
    break;
  ...
  case MOVEMENT_MAX_SPD_X:
    ...
    break;
    case MOVEMENT_MAX_SPD_E:
    paramValues[id] = MOVEMENT_MAX_SPD_E_DEFAULT;
    break;
  ...
  case MOVEMENT_INVERT_2_ENDPOINTS_X:
    ...
    break;
  case MOVEMENT_INVERT_2_ENDPOINTS_E:
    paramValues[id] = MOVEMENT_INVERT_2_ENDPOINTS_E_DEFAULT;
    break;
  ...
  case MOVEMENT_STOP_AT_MAX_X:
    ...
    break;
  case MOVEMENT_STOP_AT_MAX_E:
    paramValues[id] = MOVEMENT_STOP_AT_MAX_E_DEFAULT;
    break;
  ...
  case MOVEMENT_MOTOR_CURRENT_X:
    ...
    break;
  case MOVEMENT_MOTOR_CURRENT_E:
    paramValues[id] = MOVEMENT_MOTOR_CURRENT_E_DEFAULT;
    break;
  ...
  case MOVEMENT_STALL_SENSITIVITY_X:
    ...
    break;
  case MOVEMENT_STALL_SENSITIVITY_E:
    paramValues[id] = MOVEMENT_STALL_SENSITIVITY_E_DEFAULT;
    break;
  ...
  case MOVEMENT_MICROSTEPS_X:
    ...
    break;
  case MOVEMENT_MICROSTEPS_E:
    paramValues[id] = MOVEMENT_MICROSTEPS_E_DEFAULT;
    break;
  ...
  case ENCODER_ENABLED_X:
    ...
    break;
  case ENCODER_ENABLED_E:
    paramValues[id] = ENCODER_ENABLED_E_DEFAULT;
    break;
  ...
  case ENCODER_TYPE_X:
    ...
    break;
  case ENCODER_TYPE_E:
    paramValues[id] = ENCODER_TYPE_E_DEFAULT;
    break;
  case ENCODER_TYPE_Y:
  ...
  case ENCODER_MISSED_STEPS_MAX_X:
    ...
    break;
  case ENCODER_MISSED_STEPS_MAX_E:
    paramValues[id] = ENCODER_MISSED_STEPS_MAX_E_DEFAULT;
    break;
  ...
  case ENCODER_SCALING_X:
    ...
    break;
  case ENCODER_SCALING_E:
    paramValues[id] = ENCODER_SCALING_E_DEFAULT;
    break;
  ...
  case ENCODER_MISSED_STEPS_DECAY_X:
    ...
    break;
  case ENCODER_MISSED_STEPS_DECAY_E:
    paramValues[id] = ENCODER_MISSED_STEPS_DECAY_E_DEFAULT;
    break;
  ...
  case ENCODER_USE_FOR_POS_X:
    ...
    break;
  case ENCODER_USE_FOR_POS_E:
    paramValues[id] = ENCODER_USE_FOR_POS_E_DEFAULT;
    break;
  ...
  case ENCODER_INVERT_X:
    ...
    break;
    case ENCODER_INVERT_E:
    paramValues[id] = ENCODER_INVERT_E_DEFAULT;
    break;
