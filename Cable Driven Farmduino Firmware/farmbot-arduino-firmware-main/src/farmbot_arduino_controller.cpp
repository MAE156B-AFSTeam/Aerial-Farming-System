...
void setPinInputOutput()
{
  ...
  pinMode(E_ENCDR_A, INPUT_PULLUP);
  pinMode(E_ENCDR_B, INPUT_PULLUP);
  pinMode(E_ENCDR_A_Q, INPUT_PULLUP);
  pinMode(E_ENCDR_B_Q, INPUT_PULLUP);
...
void homeOnBoot()
{
  ...
  )
  {
    ...
    Movement::getInstance()->moveToCoords(0, 0, 0, 0, 0, 0, 0, 0, false, false, false, true);
  }
  ...
  )
  {
    ...
    Movement::getInstance()->moveToCoords(0, 0, 0, 0, 0, 0, false, false, true, false);
  }

  if
  (
  (ParameterList::getInstance()->getValue(PARAM_CONFIG_OK) == 1) &&
  (ParameterList::getInstance()->getValue(MOVEMENT_HOME_AT_BOOT_E) == 1)
  )
  {
    Serial.print("R99 HOME X ON STARTUP\r\n");
    Movement::getInstance()->moveToCoords(0, 0, 0, 0, 0, 0, false, true, false, false);
  }
  ...
  {
    Serial.print("R99 HOME X ON STARTUP\r\n");
    Movement::getInstance()->moveToCoords(0, 0, 0, 0, 0, 0, true, false, false, false);
  }
  */
}
